...
if __name__ == '__main__':
    port = int(os.getenv("PORT", 5000))  # Railway przekazuje port przez zmienną środowiskową
    app.run(host='0.0.0.0', port=port)  # Aplikacja nasłuchuje na wskazanym porcie